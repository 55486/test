...
let massengers = data["أدعية الأنبياء"]
let quraan = data["أدعية قرآنية"]
let weak_up = data["أذكار الاستيقاظ"]
let morning = data["أذكار الصباح"]
let evening = data["أذكار المساء"]
let sleeping = data["أذكار النوم"]
let aftar_salah = data["أذكار بعد السلام من الصلاة المفروضة"]
let tsabeeh = data.تسابيح
...
let azkar_container = document.getElementById('azkar_container')

azkar_container.innerHTML=`
<div id="btn_container">
<button onclick=" ziad =data["أدعية الأنبياء"]">أدعية الأنبياء</button>
<button>أدعية قرآنية</button>
<button>أذكار الاستيقاظ</button>
<button>أذكار الصباح</button>
    </div>
    <div id="btn_container">
        <button>أذكار المساء</button>
        <button>أذكار النوم</button>
        <button>أذكار بعد السلام من الصلاة المفروضة</button>
        <button>تسابيح</button>
    </div>
